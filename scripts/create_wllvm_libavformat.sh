...
LIB_INSTR_DIR=$(realpath "$BASE_DIR/experiments/AblationStudy/F_FIP/libavformat")
...
(
    ...
    cp installed/lib/libavformat.so.58.76.100 "$LIB_INSTR_DIR/libavformat.so"
    cp libavformat/libavformat.ver "$LIB_INSTR_DIR/libavformat.ver"
)
